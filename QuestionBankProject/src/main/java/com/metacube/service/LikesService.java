...
public interface LikesService {
	...
	/**
	 * @param likes
	 *            : likes object which is going to be added
	...
	/**
	 * @param likes
	 *            : likes object which is going to be merged
	 * @throws QuestionBankSystemException
	 *             : handle all system related exceptions
	 * @throws QuestionBankException
	 *             : handle all runtime exceptions
	 ...
	 *            : id of question or answer on which like is applied
	...
	/**
	 * @param likeOn
	 *            : true for question and false for answer
	 * @param questionAnswerId
	 *            : id of question or answer on which like is applied
	 * @return : no of likes
	 * @throws QuestionBankSystemException
	 ...
	 *            : true for question and false for answer
	 * @param map
	 *            : map containing required details needed
	...
	/**
	 * @param questionId
	 *            : id of question which is going to be closed
	 * @param map
	 *            : map containing required details needed
	 * @return map containing require fields
	 * @throws QuestionBankSystemException
